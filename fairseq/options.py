...
def add_datastore_args(parser):
    ...
    group.add_argument("--dstore-size", metavar="N", default=1, type=int,
                       help="datastore size")
    group.add_argument("--dstore-mmap", default=None,
                       type=str, help="save dir for datastore")
    group.add_argument("--decoder-embed-dim", metavar="N", default=1024, type=int,
                       help="decoder embedding size")
    group.add_argument("--feature-normalize", default=False, action='store_true')
    group.add_argument("--multidomain-shuffle",
                       default=False, action='store_true')
    group.add_argument("--use-knn-store", default=False, action='store_true')
    group.add_argument("--k", default=16, type=int)
    group.add_argument("--knn-coefficient", default=0,
                       type=float, help="this has been duplicated")
    ...
    group.add_argument("--use-gpu-to-search",
                       default=False, action='store_true')
    group.add_argument("--dstore-filename", default=None, type=str)
    group.add_argument("--move-dstore-to-mem",
                       default=False, action='store_true')
    ...
    group.add_argument("--only-use-max-idx",
                       default=False, action='store_true')
    group.add_argument("--save-plain-text", default=False, action='store_true')
    group.add_argument("--save-full-context", action='store_true')
    group.add_argument("--plain-text-file", default=None, type=str)

    # for deciding knn lambda value
    group.add_argument("--lambda-type", default=None, type=str,
                       help="fix, based_on_step, based_on_distance")
    group.add_argument("--lambda-value", default=0, type=float,
                       help="used when lambda type is fix")
    ...
    group.add_argument("--lambda-tend", default=None,
                       type=str, help="increase or decrease")
    group.add_argument("--lambda-curve", default='linear', type=str, help="")

    # for check knn distance and idx
    group.add_argument("--check-knn-result",
                       default=False, action='store_true')
    group.add_argument("--mt-pred-vals", type=str, default=None)
    group.add_argument("--context-txt", type=str, default=None)
...
def add_distributed_training_args(parser, default_world_size=None):
    ...
    gen_parser_from_dataclass(
        group, DistributedTrainingParams(
            distributed_world_size=default_world_size)
    )
    return group
...
def add_knn_record_args(parser):
    ...
    # fmt: off
    group.add_argument('--knn-record-index',
                       default=False, action='store_true')
    group.add_argument('--knn-record-distance',
                       default=False, action='store_true')
    group.add_argument('--knn-record-lambda',
                       default=False, action='store_true')
    group.add_argument('--knn-record-label-counts',
                       default=False, action='store_true')